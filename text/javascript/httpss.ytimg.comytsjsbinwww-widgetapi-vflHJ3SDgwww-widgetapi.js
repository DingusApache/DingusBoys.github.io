(function() {
    ...
    var oa = Array.prototype.indexOf ? function(a, b, c) {
        ...
        x = Array.prototype.forEach ? function(a, b, c) {
            ...
            for (var d = a.length, e = m(a) ? a.split("") : a, h = 0; h < d; h++) h in e && b.call(c, e[h], h, a)
        };
    ...
    var Fa = A("Opera"),
        H = A("Trident") || A("MSIE"),
        Ga = A("Edge"),
        I = A("Gecko") && !(-1 != z.toLowerCase().indexOf("webkit") && !A("Edge")) && !(A("Trident") || A("MSIE")) && !A("Edge"),
        Ha = -1 != z.toLowerCase().indexOf("webkit") && !A("Edge");
    ...
    a: {
        var Ka = "",
            La = function() {
                ...
                if (Ga) return /Edge\/([\d\.]+)/.exec(a);
                if (H) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
                if (Ha) return /WebKit\/(\S+)/.exec(a);
    ...
    function Oa(a) {
        Da(a, function() {
            for (var b = 0, c = ga(String(Na)).split("."), d = ga(String(a)).split("."), e = Math.max(c.length, d.length), h = 0; 0 == b && h < e; h++) {
                var f = c[h] || "",
                    l = d[h] || "";
                do {
                    f = /(\d*)(\D*)(.*)/.exec(f) || ["", "", "", ""];
                    ...
                    b = w(0 == f[1].length ? 0 : parseInt(f[1], 10), 0 == l[1].length ? 0 : parseInt(l[1], 10)) || w(0 == f[2].length, 0 == l[2].length) || w(f[2], l[2]);
                    f = f[3];
                    l = l[3]
                } while (0 == b)
            }
    ...
    var Pa;
    var Qa = k.document;
    Pa = Qa && H ? Ia() || ("CSS1Compat" == Qa.compatMode ? parseInt(Na, 10) : 5) : void 0;
    var Ra;
    if (!(Ra = !I && !H)) {
        var Sa;
        if (Sa = H) Sa = 9 <= Number(Pa);
        Ra = Sa
    }
    Ra || I && Oa("1.9.1");
    H && Oa("9");
    ...
    function Ta(a) {
        ...
        if (a && e.getElementsByClassName) return d = e.getElementsByClassName(a);
        ...
        if (a) {
            ...
            for (b = c = 0; e = d[b]; b++) {
                var f = e.className,
                    l;
                if (l = "function" == typeof f.split) l = 0 <= oa(f.split(/\s+/), a);
                l && (h[c++] = e)
            }
            h.length = c;
            return h
    ...
    var J = "StopIteration" in k ? k.StopIteration : {
    ...
    function lb(a, b) {
        ...
        c ? c(a, b, void 0, void 0, void 0) : (c = [], c = "ERRORS" in O ? O.ERRORS : c, c.push([a, b, void 0, void 0, void 0]), kb("ERRORS", c))
    }
    ...
    var nb = 0,
        ob = n("ytDomDomGetNextId") || function() {
            return ++nb
        };
    u("ytDomDomGetNextId", ob);
    var pb = {
    ...
    function P(a) {
        ...
        if (a = a || window.event) {
            this.a = a;
            for (var b in a) b in pb || (this[b] = a[b]);
    ...
    var qb = n("ytEventsEventsCounter") || {
        count: 0
    };
    u("ytEventsEventsCounter", qb);
    ...
    function tb(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                var e = ++qb.count + "",
                    h = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document);
                var f = h ? function(d) {
                    d = new P(d);
                    if (!Ua(d.relatedTarget, function(b) {
                            return b == a
                ...
                f = mb(f);
                a.addEventListener ? ("mouseenter" == b && h ? b = "mouseover" : "mouseleave" == b && h ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), a.addEventListener(b, f, d)) : a.attachEvent("on" + b, f);
                B[e] = [a, b, c, f, d]
            }
        }
    };
    ...
    function wb(a) {
        return vb[a] || (vb[a] = String(a).replace(/\-([a-z])/g, function(a, c) {
    ...
    function Ab(a) {
        ...
        a = "yt-" + a;
        var c = document;
        a = y(c.querySelectorAll && c.querySelector ? c.querySelectorAll("." + a) : Ta(a));
        return qa(b, a)
    }

    function R(a, b) {
        return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[wb(b)] : a.getAttribute("data-" + b) : null
    }
    ...
    function S(a, b, c) {
        ...
        this.v = {};
        b = document;
        if (a = m(a) ? b.getElementById(a) : a)
            if ("iframe" != a.tagName.toLowerCase() && (b = Cb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (b = a = this.a, b = b[r] || (b[r] = ++ca), a.id = "widget" + b), Q[this.a.id] = this, window.postMessage) {
                this.f = new L;
                Db(this);
                a = T(this.b, "events");
                for (var d in a) a.hasOwnProperty(d) && this.addEventListener(d, a[d]);
                for (var e in yb) Eb(this,
                    e)
            }
    }
    g = S.prototype;
    ...
    function Db(a) {
        Gb(a.b, a, a.g);
        a.c = ub(t(a.H, a));
        tb(a.a, "load", t(function() {
            window.clearInterval(this.c);
            this.c = ub(t(this.H, this))
        }, a))
    }
    ...
    g.C = function(a) {
        ...
        h && (f += "//", e && (f += e + "@"), f += h, c && (f += ":" + c));
        d = f;
        b = 0 == d.indexOf("https:") ? [d] : b.b ? [d.replace("http:", "https:")] : b.f ? [d] : [d, d.replace("http:", "https:")];
        if (!this.a.contentWindow) throw Error("The YouTube player is not attached to the DOM.");
        for (d = 0; d < b.length; d++) try {
            this.a.contentWindow.postMessage(a, b[d])
        } catch (l) {
            if (l.name && "SyntaxError" == l.name) lb(l,
                "WARNING");
            else throw l;
        }
    };
    ...
    function Mb(a, b) {
        x(b, function(a) {
            this[a] || ("getCurrentTime" == a ? this[a] = function() {
                ...
                return a
            } : Ib(a) ? this[a] = function() {
                this.j = {};
                this.i = {};
                V(this, a, arguments);
                return this
            } : Hb(a) ? this[a] = function() {
                var b = 0;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || zb();
    var Qb = n("onYTReady");
    Qb && Qb();
    var Rb = n("onYouTubeIframeAPIReady");
    Rb && Rb();
    var Sb = n("onYouTubePlayerAPIReady");
    Sb && Sb();
}).call(this);